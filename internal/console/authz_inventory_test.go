...
var consoleRoutePolicies = []routePolicy{
	...
	{"GET", "/api/traces/{id}", "member", ""},
	{"GET", "/api/traces/{id}/export", "member", ""},
	{"GET", "/api/gateway/capabilities", "member", ""},
	{"GET", "/api/turns", "member", ""},
	{"GET", "/api/stats", "member", ""},
	{"GET", "/api/stats/providers", "member", ""},
	{"GET", "/api/live", "member", ""},
	{"GET", "/api/live/mcp", "member", ""},
	{"GET", "/api/mcp-logs/", "member", ""},
	{"GET", "/api/mcp-logs/filterdata", "member", ""},
	{"GET", "/api/mcp-logs/stats", "member", ""},
	{"GET", "/api/mcp-logs/{id}", "member", ""},
