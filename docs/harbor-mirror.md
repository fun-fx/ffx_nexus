...
The CD pipeline (`cd-prod.yml`) pulls from `harbor.tail7d361a.ts.net/ffx/nexus`,
...
docker login harbor.tail7d361a.ts.net
...
docker push harbor.tail7d361a.ts.net/...` with a Harbor robot account stored
